...
const contacts = [
    { title: 'Telegram', description: '@kiwi_animatori', icon: <BsTelegram className='w-7 h-7' /> },
    { title: 'WhatsApp', description: '+37120012057', icon: <BsWhatsapp className='w-7 h-7' /> },
    { title: 'Email', description: 'kiwianimation@gmail.com', icon: <BsEnvelope className='w-7 h-7' /> },
